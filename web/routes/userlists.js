...
function getBuddyMessageContent(user) {
  var intro =
    'Wow, what a momentous occasion! Now go return the favour...<br><br>';
  var profile =
    'Profile: <a href="/user/' +
    user.urlname +
    '">/user/' +
...
module.exports = function routing(app, api) {
  // favourites
  app.put(
    '/thread/:threadUrlName/favourite',
    checkAuth,
  ...
  app.put(
    '/thread/:threadUrlName/unfavourite',
    checkAuth,
    function (req, res, next) {
      api.modifyUserList(
        res,
